...
| runs | $factors=3$ | $factors=4$ | $factors=5$ | $factors=6$ | $factors=7$ | $factors=8$ |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| **16** | | $2^4$ ✅<br>*(full)* | $2_{V}^{5-1}$ ⚠️<br>$\pm E=ABCD$ | $2_{IV}^{6-2}$ ⚠️<br>$\pm E=ABC$<br>$\pm F=ABD$ | $2_{IV}^{7-3}$ ⚠️<br>$\pm E=ABC$<br>$\pm F=ABD$<br>$\pm G=ACD$ | $2_{IV}^{8-4}$ ⚠️<br>$\pm E=ABC$<br>$\pm F=ABD$<br>$\pm G=ACD$<br>$\pm H=BCD$ |
| **32** | | | $2^5$ ✅<br>*(full)* | $2_{VI}^{6-1}$ ⚠️<br>$\pm F=ABCDE$ | $2_{IV}^{7-2}$ ⚠️<br>$\pm F=ABC$<br>$\pm G=ABDE$ | $2_{IV}^{8-3}$ ⚠️<br>$\pm F=ABC$<br>$\pm G=ABD$<br>$\pm H=ACDE$ |
| **64** | | | | $2^6$ ✅<br>*(full)* | $2_{VII}^{7-1}$ ⚠️<br>$\pm G=ABCDEF$ | $2_{V}^{8-2}$ ⚠️<br>$\pm G=ABCD$<br>$\pm H=ABEF$ |
